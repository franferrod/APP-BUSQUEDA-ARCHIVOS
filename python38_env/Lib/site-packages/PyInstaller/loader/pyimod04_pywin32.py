...
def install():
    ...
    # NOTE: On Windows 7, os.add_dll_directory exists in Python 3.8 but the underlying
    # AddDllDirectory API does not exist, causing WinError 127. We catch this and fall
    # through to the PATH-based approach below.
