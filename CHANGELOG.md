...
- **El banco de pruebas vuelve a ser fiable.** Varias baterías terminaban con error aunque pasaran todas sus comprobaciones: al acabar, el arnés desmontaba la aplicación con sus hilos de fondo todavía vivos y Windows mataba el proceso. No cambia nada de lo que ves en la app, pero sin eso no se podía distinguir un fallo de verdad de una caída al cerrar. **353 comprobaciones, todas en verde.**
