...
- **Filtros de propiedades SW en cascada**: Material, Tratamiento, Cierre y Espesor ahora se filtran según el contexto (origen, años, clientes y proyectos seleccionados), igual que Clientes/Proyectos — ej. al marcar un proyecto solo se ofrecen los materiales y espesores que realmente usa. La consulta corre en segundo plano (0,6 s en el peor caso, ~10 ms con cliente/proyecto marcado) y no afecta a la fluidez. Lo que ya esté marcado nunca se oculta, y "Todos" solo marca los valores disponibles.
