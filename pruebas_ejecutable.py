# -*- coding: utf-8 -*-
"""Pruebas del EJECUTABLE empaquetado del Buscador de Piezas ALSI (V2.1.3).
...
Por defecto usa releases/v2.1.3/BuscadorPiezas.exe. Cierra siempre los procesos
...
EXE = (sys.argv[1] if len(sys.argv) > 1 and sys.argv[1].endswith(".exe")
       else os.path.join(PROYECTO, "releases", "v2.1.3", "BuscadorPiezas.exe"))
